...
function OrderSummary() {
  ...
  return (
    <div className="flex xl:flex-row max-xl:flex-col h-screen m-2 xl:space-x-2 max-xl:space-y-4">
      <BusinessDetails />
      <div className="flex flex-row xl:mt-20 xl:w-[60%] max-sm:flex-col max-xl:w-full border border-gray-300 rounded-[20px]">
        <div className="flex flex-col w-[50%] max-sm:w-full">
          ...
          <ul className="flex flex-col space-y-2 mb-[10px]">
            {feature.map((item, index) => (
              <li
                key={index}
                className="flex flex-row justify-between p-2 hover:text-white hover:bg-indigo-600 rounded-[8px] ms-3 w-[90%] border border-gray-300 
               bg-gray-100 
             items-center"
              >
